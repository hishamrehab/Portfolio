...
export const projects = [
  {
    ...
    des: "Ultimate MovieHub is a user-friendly movie site built with React, Redux Toolkit, Material UI, Vite, Firebase, and IMDb. It features a searchable movie catalog, user authentication, and a responsive design for all devices, along with user reviews, ratings, dark/light mode, and personalized recommendations. ",
